#String Data Type 
 ...
 An alphanumeric data type. 
     ...
     storage: physical space in the computer drive's memory where the data is being saved or stored 
...
The different between the both is the way the value is represented in the memory of the computer.
...
TIMESTAMP
    ...
    ADVANTAGES: 
		it saves the moment in time as the number of second passed after the 1st of January 1970
